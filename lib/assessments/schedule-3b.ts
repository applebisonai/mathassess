...
export const schedule3B = {
  ...
  taskGroups: [
    ...
    // ─────────────────────────────────────────────────────────────────────
    {
      ...
      model: "SN20",
      color: "indigo",
      instructions: "Show task card with a number. Ask student to name two parts of that number.",
      teacherScript: '"Tell me two parts of ___." (show task card)',
      materials: "Task Cards",
      items: [
        {
          id: "6a", number: "Partitions 1–9", targetLevel: 4,
          prompt: "Tell me two parts of 6", displayText: "6",
          responseFields: [{ label: "Correct", type: "correct_incorrect" }, STRATEGY_FIELD],
        },
        {
          id: "6b", number: "Partitions 1–9", targetLevel: 4,
          prompt: "Tell me two parts of 9", displayText: "9",
          responseFields: [{ label: "Correct", type: "correct_incorrect" }, STRATEGY_FIELD],
        },
      ],
    },
    ...
    // ─────────────────────────────────────────────────────────────────────
    {
      ...
      model: "SN20",
      color: "indigo",
      instructions: "Show task card with a teen number. Ask student to name two parts.",
      teacherScript: '"Tell me two parts of ___." (show task card)',
      materials: "Task Cards",
      items: [
        {
          id: "7a", number: "Partitions 11–20", targetLevel: 7,
          prompt: "Tell me two parts of 12", displayText: "12",
          responseFields: [{ label: "Correct", type: "correct_incorrect" }, STRATEGY_FIELD],
        },
        {
          id: "7b", number: "Partitions 11–20", targetLevel: 7,
          prompt: "Tell me two parts of 19", displayText: "19",
          responseFields: [{ label: "Correct", type: "correct_incorrect" }, STRATEGY_FIELD],
        },
      ],
    },
