...
const CATEGORIES = [
  ...
  },
  {
    ...
    assessments: [
      {
        id: "av-nwn",
        name: "AVMR 1A — Number Words & Numerals",
        description: "Forward/backward sequences, numeral ID to 100",
        gradeRange: "K–1",
        models: ["FNWS", "BNWS", "NID"],
        route: "",
        available: false,
      ...
      {
        id: "av-spatial",
        name: "AVMR 1B — Spatial & Finger Patterns",
        description: "Domino/dice patterns, finger patterns, doubles",
        gradeRange: "K–2",
        models: ["SF"],
        route: "",
        available: false,
      ...
      {
        id: "av-arith",
        name: "AVMR 1C — Early Arithmetical Strategies",
        description: "Counting-on/back, combining & partitioning to 20",
        gradeRange: "K–2",
        models: ["SEAL"],
        route: "",
        available: false,
      ...
      {
        id: "av-pv",
        name: "AVMR 2A — Tens & Ones",
        description: "Bundling, place value tasks, adding/subtracting decades",
        gradeRange: "1–3",
        models: ["CPV"],
        route: "",
        available: false,
      ...
      {
        id: "av-multdiv",
        name: "AVMR 2B — Multiplication & Division",
        description: "Equal groups, arrays, skip counting, sharing",
        gradeRange: "2–5",
        models: ["M&D"],
        route: "",
        available: false,
