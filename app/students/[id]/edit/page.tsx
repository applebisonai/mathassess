  ...
  useEffect(() => {
    async function load() {
      ...
      if (data) {
        ...
        setGradeLevel(data.grade_level ?? 0);
      }
      setLoading(false);
    }
    load();
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-lg mx-auto px-4 py-8">
        ...
        <div className="mt-4 mb-6">
          ...
          <p className="text-gray-500 text-sm">Update name or grade level.</p>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              <Link
                href={`/students/${params.id}`}
                className="flex-1 text-center border border-gray-300 text-gray-600 font-medium rounded-lg py-2.5 text-sm hover:bg-gray-50"
              >
                Cancel
              </Link>
              <button
